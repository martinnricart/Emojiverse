...
import CopyEmojiButton from './CopyEmojiButton';
      ...
      <React.Fragment>
        <div className="bg-[#F7F6F3] p-2 rounded-xl shadow-md flex flex-col items-center">
          ...
          <button
            ...
            className="text-blue-500 text-sm pt-3 hover:text-blue-300"
          >
            🤔More Info
          </button>
          <button className="text-blue-500 text-sm pt-3 hover:text-blue-300"> <CopyEmojiButton emoji={emoji} /> </button>
